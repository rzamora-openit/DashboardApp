...
namespace OpeniT.PowerbiDashboardApp.Controllers.Api.Dashboard
{
	...
	public class PowerbiAccessController : ControllerBase
	{
		...
		private readonly IPowerBIQueryRepository powerBIQuery;
		private readonly IPowerBIEmbedHelper powerBIEmbedHelper;
		private readonly IApplicationLogger logger;

		public PowerbiAccessController(IDataRepository dataRepository,
						IPowerBIQueryRepository powerBIQuery,
						IPowerBIEmbedHelper powerBIEmbedHelper,
